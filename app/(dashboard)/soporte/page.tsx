...
const channels = [
  {
    icon: RiMessage2Line,
    title: "Chat en vivo",
    description: "Chateá con nuestro equipo en tiempo real.",
    action: "Iniciar chat",
    href: "#",
  },
  {
    icon: RiMailLine,
    title: "Email",
    description: "Enviános un mensaje y te respondemos en 24h.",
  ...
  },
  {
    ...
    description: "Guías, preguntas frecuentes y documentación.",
      ...
      <div className="mx-auto max-w-3xl px-6 py-10 lg:px-8 lg:py-14">
        ...
        <div className="mb-12">
          ...
          <p className="mt-3 max-w-lg text-lg text-[#666666] leading-relaxed">
            Comunicate con nuestro equipo o encontrá respuestas por tu cuenta.
          </p>
        </div>
        ...
        <div className="space-y-4">
          {channels.map((channel) => (
            ...
            >
              <div className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-[#111111]/10 group-hover:bg-[#111111]/20 transition-colors">
                <channel.icon className="size-5 text-[#111111]" />
              </div>
              ...
              <span className="text-sm font-semibold text-[#111111] group-hover:text-[#222222]">
                {channel.action}
              </span>
            </Link>
          ))}
        ...
        <div className="mt-10 rounded-2xl border border-[#E5E5E5] bg-white p-7 lg:p-8">
          ...
          <div className="space-y-4">
            {[
              { q: "¿Cuánto tardan los depósitos?", a: "Las transferencias ACH se liquidan en 3 a 5 días hábiles. Las transferencias wire y crypto suelen ser el mismo día." },
              { q: "¿Cuáles son las comisiones?", a: "Los depósitos son gratis. Los retiros tienen una comisión fija según el método — consultá la pantalla de retiro para más detalles." },
              { q: "¿Qué monedas están disponibles?", a: "USD, ARS y USDT. Más monedas próximamente." },
            ].map((faq) => (

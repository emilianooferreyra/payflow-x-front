...
const USD_FIELDS = [
  { label: "Bank Name", value: bankingInstructions[0].fields[4].value },
  { label: "Account Holder", value: bankingInstructions[0].fields[0].value },
  { label: "Routing Number", value: bankingInstructions[0].fields[2].value },
  { label: "Account Number", value: bankingInstructions[0].fields[1].value },
  { label: "SWIFT / BIC Code", value: bankingInstructions[1].fields[2].value },
]
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              >
                {copiedField === field.label ? (
                  <RiCheckLine className="size-4 text-[#7C3AED]" />
                ) : (
